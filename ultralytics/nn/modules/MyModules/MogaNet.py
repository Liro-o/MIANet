...
class ChannelAggregationFFN(nn.Module):
    ...
    def __init__(self,
        ...
        self.triple = TripletAttention(gate_channels=self.feedforward_channels)
...
class MogaBlock(nn.Module):
    ...
    def __init__(self,
        ...
        self.scam = SCAM(in_channels=embed_dims)
    ...
    def forward(self, x):
        # spatial
        identity = x
        x = self.layer_scale_1 * self.scam(self.norm1(x))
